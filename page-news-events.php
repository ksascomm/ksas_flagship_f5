	...
	<div class="small-12 columns">
		...
		<!-- ************START NEWS & FEATURED VIDEO SECTION************* -->
			<div class="small-12 large-4 columns" id="news_section">
				<!-- ************START NEWS -->
				<div class="banner blue_bg offset-gutter radius-topleft" style="margin-top: -3px">
					<h3>
						<a href="/news-events/articles" class="dark_blue_bg radius-topleft">Arts &amp; Sciences News</a>
					</h3>
				</div>
					<?php if ( false === ( $flagship_news_query = get_transient( 'flagship_news_query' ) ) ) {
			...
			<!-- ************DEPARTMENT & HUB SECTION************* -->
					<div id="aggregate_section">
						<div class="banner blue_bg offset-gutter">
							<h3>
								<a class="dark_blue_bg" href="http://hub.jhu.edu/divisions/school-arts-and-sciences">From the Hub</a>
							</h3>
						</div>
						<?php
